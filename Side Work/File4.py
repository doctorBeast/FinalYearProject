...
#
# images = glob.glob('C:/Users/jatin/Desktop/Github/FinalYearProject/Side Work/ImagesRight/*.jpg')
# i = 0
# for fname in images:
...
srcL = cv2.imread('C:/Users/jatin/Desktop/Github/FinalYearProject/Side Work/BothNew/imgL2.jpg',1)
...
srcR = cv2.imread('C:/Users/jatin/Desktop/Github/FinalYearProject/Side Work/BothNew/imgR2.jpg',1)
...
dstR = dstR[yr:yr+hr-20,xr:xr+w]
dstL = dstL[yl+14:yl+hl,xl:xl+w]
...
cv2.imwrite('dstImages/dstL2.jpg',dstL)
cv2.imwrite('dstImages/dstR2.jpg',dstR)
