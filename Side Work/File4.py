...
srcL = cv2.imread('/home/doctorbeast/Desktop/Github/FinalYearProject/Both/imgL0.jpg',1)
...
srcR = cv2.imread('/home/doctorbeast/Desktop/Github/FinalYearProject/Both/imgR0.jpg',1)
...
dstR = dstR[yr+45:yr+h-150,xr:xr+w]
dstL = dstL[yl+45:yl+h-150,xl:xl+w]
...
cv2.imwrite('dstImages/dstL0.jpg',dstL)
cv2.imwrite('dstImages/dstR0.jpg',dstR)
